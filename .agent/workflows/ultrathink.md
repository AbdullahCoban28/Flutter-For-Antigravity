...
> [!IMPORTANT]
> **Language Rule**: All interactions, responses, and outputs provided by the agent must be in Turkish language (Türkçe). English may be used for technical terminology where appropriate, but the primary language must be Turkish.
